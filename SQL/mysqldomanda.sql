...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=latin1 COMMENT='informazioni sugli oggetti venduti';
...
INSERT INTO `asta` (`idasta`,`titolo`,`descrizione`,`prezzobase`,`stato`,`idutentevenditore`,`stamp_creazione`,`stamp_scadenza`,`idcategoria`,`idutenteaggiudicatario`,`prezzoaggiudicato`) VALUES 
 ...
 (78,'radio','','10','aggiudicata',12,'2011-07-18 18:00:00','2011-07-23 12:00:00',4,11,12),
 (79,'robot','','12','attiva',12,'2011-01-12 12:11:00','2012-11-13 12:11:00',4,NULL,NULL),
 (85,'Suzuki','','1323','attiva',12,'2011-01-12 12:11:00','2012-11-13 12:11:00',1,NULL,NULL),
 (86,'Ferrari','','1329288','caricata',12,'2011-01-12 12:11:00','2012-11-13 12:11:00',1,NULL,NULL),
 (87,'Harry Potter','','13','attiva',12,'2011-01-12 12:11:00','2012-11-13 12:11:00',3,NULL,NULL),
 ...
 (98,'iphone','apple iphone steve jobs','123','attiva',13,'2001-11-11 12:00:00','2011-11-12 12:00:00',4,NULL,NULL);
...
CREATE TABLE `domanda` (
  ...
  `idutentedomanda` int(10) unsigned NOT NULL,
  `idutenterisposta` int(10) unsigned NOT NULL,
  `domanda` varchar(45) NOT NULL,
  `risposta` varchar(45) NOT NULL,
  `valutazione` int(10) unsigned NOT NULL,
  PRIMARY KEY (`idDomanda`) USING BTREE
...
INSERT INTO `domanda` (`idDomanda`,`idasta`,`idutentedomanda`,`idutenterisposta`,`domanda`,`risposta`,`valutazione`) VALUES 
 (1,77,12,11,'Che tipologia? u12-a77','aidgiasd',0),
 (2,0,11,11,'rispondidasolo?','Nessuna risposta',0),
 (3,77,13,11,'Che tipologia? u11-a77','Nessuna risposta',0),
 (6,74,13,11,'che tipo? 13-77','Nessuna risposta',0),
 (7,74,13,11,'che tipo? 13-76','Nessuna risposta',0),
 (8,79,13,12,'Ciao funziona?','Non so ancora... chiedo alla macchinina!',5),
 (10,79,11,12,'Ciao, è robotronic?','Cia si penso di si',0),
 (11,79,13,12,'Ciao Rifunziona?','Nessuna risposta',0),
 (19,74,12,11,'Ciao cosè ggg?','è una cosa molto buona',5),
 (20,98,12,13,'ciao funziona?','Si funziona!',0),
 (21,79,11,12,'Ciao come funziona?','Inserisci e via!',0),
 (22,74,13,11,'Che tipo è?','Booc',0),
 (23,79,13,12,'Ciao Come va?','Ti pare il caso?',0),
 (24,98,12,13,'Sconti?','Nain nain',2),
 (25,98,12,13,'Ciao è rotto?','Nessuna risposta',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=latin1 COMMENT='le offerte dei diversi utenti offerenti per ciascuna asta';
...
INSERT INTO `offerta` (`idofferta`,`idutenteofferente`,`idasta`,`offerta`,`valida`,`stamp`) VALUES 
 ...
 (35,12,77,'14',0,'2002-01-01 21:23:46'),
 (36,13,74,'0',1,'2002-01-01 04:33:04'),
 (37,13,79,'12',1,'2002-01-01 00:59:49'),
 (38,12,98,'0',0,'2011-08-10 18:34:32'),
 (39,12,98,'2',0,'2011-08-10 18:38:05'),
 (40,12,98,'1',0,'2011-08-10 18:38:17'),
 (41,12,98,'1',0,'2011-08-10 18:56:48'),
 (42,12,98,'12',0,'2011-08-10 18:56:58'),
 (43,12,98,'11',1,'2011-08-10 18:57:08');
